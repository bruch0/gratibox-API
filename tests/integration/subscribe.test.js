...
describe('post subscribe', () => {
  ...
  it('should return 201 when sending valid body and token via x-access-token', async () => {
    const validBody = {
      plan: faker.random.arrayElement(['monthly', 'weekly']),
      deliveryDate: faker.random.arrayElement(['01', '10', '20']),
      itemsWanted: [faker.random.arrayElement(['1', '2', '3'])],
  ...
  it('should return 409 when trying to make another subscription on post method', async () => {
    const validBody = {
      plan: faker.random.arrayElement(['monthly', 'weekly']),
      deliveryDate: faker.random.arrayElement(['01', '10', '20']),
      itemsWanted: [faker.random.arrayElement(['1', '2', '3'])],
...
describe('put subscribe', () => {
  ...
  it('should return 401 when not sending jwt via x-access-token', async () => {
    const token = await createToken();
    const result = await request.put('/subscribe').set('Authorization', token);
    expect(result.status).toEqual(401);
  });
  ...
  it('should return 401 when sending valid body, but no jwt', async () => {
    ...
    const result = await request.put('/subscribe').send(validBody);
    expect(result.status).toEqual(401);
  });
  ...
  it('should return 400 when sending jwt via x-access-token, but no body', async () => {
    const { token } = await createToken();
    const result = await request.put('/subscribe').set('x-access-token', token);
    expect(result.status).toEqual(400);
  });
  ...
  it('should return 400 when sending valid body and token via x-access-token, but the user has no subscription already', async () => {
    const validBody = {
      plan: faker.random.arrayElement(['monthly', 'weekly']),
      deliveryDate: faker.random.arrayElement(['01', '10', '20']),
      itemsWanted: [faker.random.arrayElement(['1', '2', '3'])],
  ...
  it('should return 200 when trying to make another subscription on put method', async () => {
    const validBody = {
      plan: faker.random.arrayElement(['monthly', 'weekly']),
      deliveryDate: faker.random.arrayElement(['01', '10', '20']),
      itemsWanted: [faker.random.arrayElement(['1', '2', '3'])],
